...
<head>
    <meta charset="UTF-8">
    <title>Ueditor in CodeIgniter 4!</title>
...
<header>
    ...
    <div class="heroe">
        ...
        <h1>Welcome to Ueditor In CodeIgniter <?= CodeIgniter\CodeIgniter::CI_VERSION ?></h1>
...
<section>
    ...
    BOF
    <!-- UEDITOR BOF --> 
    <h1>Ueditor in CodeIgniter 4</h1>
    ...
    <code id="content" style="display: none;">
      <span class="signature_default_set">Additional Content : Noor modified this ueditor for CodeIgniter 4</span>
    </code>
    <script type="text/javascript">
        $(window).load(function() { 

            var ue=UE.getEditor('editor',{ serverUrl:'/ueditor'});
            ...
            //additional toolbar add
            var html='<select name="signature" id="signature"><option>New 1<option></select>';
            $("#edui2").append(html);
            var temphtml='<select  name="template" id="template"><option>New 2<option></select>';
